<template>
    <div class="qudao">
        <div class="qudao-title">
             <div class="fr"><el-button type="danger" @click="dialogAddVisible=true">添加渠道</el-button></div>
            <h3>渠道管理</h3>
        </div>
        <div>
            <div>
            ...
            <div>
                <span>渠道名称</span>
                <el-input placeholder="请输入渠道名称" v-model="channelName" class="input-with-select">
        ...
        <el-dialog title="权限信息" :visible.sync="dialogAddVisible" :close-on-click-modal="false">
            <div>
                <div>
                    <span style="width: 12%; display: inline-block; text-align: right" class="mr10">渠道名称</span>
                    <el-input style="width: 30%" v-model="dialog_channelName" placeholder="请输入渠道名称"></el-input>
                </div>
                <div class="mt10">
...
export default {
    data () {
        return {
            ...
            dialogAddVisible: false, // 弹出层-添加渠道
            dialog_channelName: '', // 弹出层-渠道名称
    ...
    methods: {
         ...
         * 弹出层-权限类型选择
         */
        handleCheckedchannelsChange (val) {
            console.info(val)
        }
    }
}
