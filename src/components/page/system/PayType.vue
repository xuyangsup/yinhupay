<template>
    <div class="shouyinfangshi">
        <div class="shouyinfangshi-title">
             <!-- <div class="fr"><el-button type="danger" @click="dialogAddVisible=true">添加收银</el-button></div> -->
            <h3>收银方式</h3>
        </div>
        <div>
            <div>
            ...
            <div>
                <span>收银方式</span>
                <el-input placeholder="请输入收银方式" v-model="payName" class="input-with-select">
        ...
        <!-- 弹出框-收银 -->
        <el-dialog title="收银方式" :visible.sync="dialogAddVisible" :close-on-click-modal="false">
            <div>
                <div>
                    <span style="width: 12%; display: inline-block; text-align: right" class="mr10">收银方式</span>
                    <el-input style="width: 30%" v-model="dialog_payName" placeholder="请输入收银方式"></el-input>
                </div>
                <div class="mt10">
...
export default {
    data () {
        return {
            ...
            dialogAddVisible: false, // 弹出层-添加收银
            dialog_payName: '', // 弹出层-收银名称
